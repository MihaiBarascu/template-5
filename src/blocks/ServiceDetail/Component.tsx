...
export function ServiceDetailBlock({
  ...
  const l = {
    ...
    requirementsTitle:
      labels.requirementsTitle || 'Cerinte / Echipament necesar',
  ...
  const difficultyLabels = {
    ...defaultDifficultyLabels,
    ...(labels.difficultyLabels || {}),
  };
  const _serviceTypeLabels = {
    ...defaultServiceTypeLabels,
  ...
  const assignedTeamMember =
    serviceData.assignedTeamMember as TeamMember | null;
  ...
  const bookingLink =
    ctaButtonLink ||
    `${paths.bookingPath}?serviciu=${encodeURIComponent(serviceData.title)}`;
              ...
              <div className="p-8">
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  {serviceData.displayStyle && (
                    <span className="px-3 py-1 rounded-full text-sm font-medium bg-theme-primary/10 text-theme-primary">
                      {serviceData.displayStyle}
                    </span>
                  )}
                  {serviceData.difficulty && (
                ...
                <h1 className="heading-h2 font-bold text-theme-dark mb-4">
                  {serviceData.title}
                </h1>

                {serviceData.shortDescription && (
                  <p className="text-lg text-theme-text-light mb-6">
                    {serviceData.shortDescription}
                  </p>
                )}
  ...
  return (
    <section className={`min-h-screen ${bgClass}`}>
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              {image?.url ? (
                ...
                <div className="h-72 md:h-96 lg:h-[450px] bg-gradient-to-br from-theme-primary/20 to-theme-dark/20 flex items-center justify-center">
                  <DynamicIcon
                    iconName={serviceData.icon}
                    className="w-32 h-32 text-theme-primary/50"
                  />
                </div>
              ) : (
                <div className="h-72 md:h-96 lg:h-[450px] bg-gradient-to-br from-theme-primary/20 to-theme-dark/20 flex items-center justify-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pb-6 border-b border-theme-border">
                  ...
                  {assignedTeamMember && (
                    <div className="text-center col-span-2 md:col-span-1">
                      ...
                      <p className="text-sm text-theme-text-light">
                        {assignedTeamMember.role || l.teamMemberTitle}
                      </p>
                    </div>
                  )}
                </div>
              ...
              serviceData.features.length > 0 && (
                <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="heading-h2 font-bold text-theme-dark">
                      {l.featuresTitle}
                    </h2>
                  </div>
          ...
          <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-8 lg:self-start">
            ...
            {showSchedule &&
              ...
              serviceData.schedule.length > 0 && (
                <div className="bg-white rounded-xl shadow-lg p-6">
                  <div className="flex items-center gap-3 mb-6">
                    <Calendar className="w-6 h-6 text-theme-primary" />
                    <h3 className="heading-h3 font-bold text-theme-dark">
                      {l.scheduleTitle}
                    </h3>
                  </div>
                  <div className="space-y-3">
                    {serviceData.schedule.map((item, index) => (
                      ...
                      >
                        <div>
                          ...
                          {item.room && (
                            <span className="block text-sm text-theme-text-light">
                              {item.room}
                            </span>
                          )}
                        </div>
            ...
            {showPricing && hasAttributes && (
              <div className="bg-gradient-to-br from-theme-primary to-theme-primary/90 rounded-xl shadow-lg p-6 text-white">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="heading-h3 font-bold">{l.pricingTitle}</h3>
                </div>
                    ...
                    <div
                      ...
                      className={
                        index < attributes.length - 1
                          ? 'pb-4 border-b border-white/20 mb-4'
                          : ''
                      }
                    >
                      <p className="text-sm text-white/80 mb-1">{attr.label}</p>
                      <p className="heading-h2 font-bold">{attr.value}</p>
                    </div>
                  ))}
                </div>
                <Link
            ...
            {showTeamMember && assignedTeamMember && (
              <div className="bg-white rounded-xl shadow-lg p-6">
                <h3 className="text-lg font-bold text-theme-dark mb-4">
                  {l.teamMemberTitle}
                </h3>
                <Link
                  href={`${paths.teamBasePath}/${assignedTeamMember.slug || ''}`}
                  ...
                  <div className="flex items-center gap-4">
                    {teamMemberImage?.url ? (
                      ...
                      <div className="w-16 h-16 rounded-full bg-theme-primary/20 flex items-center justify-center">
                        <span className="heading-h2 font-bold text-theme-primary">
        ...
        {showRelatedServices && relatedServices.length > 0 && (
          <div className="mt-16">
            <h2 className="heading-h2 font-bold text-theme-dark mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {relatedServices.map(relatedService => {
                ...
                return (
                  ...
                  >
                    <Link
                      href={`${paths.servicesBasePath}/${relatedService.slug}`}
                    >
                        ...
                        {relatedImage?.url ? (
                          ...
                          <div className="h-full bg-gradient-to-br from-theme-primary/20 to-theme-dark/20 flex items-center justify-center">
                            <DynamicIcon
                              ...
                              className="w-16 h-16 text-theme-primary/50"
                            />
                          </div>
                        ) : (
                          <div className="h-full bg-gradient-to-br from-theme-primary/20 to-theme-dark/20 flex items-center justify-center">
