...
export function Footer({ data, businessInfo, logo }: FooterProps) {
  ...
  const borderClass = colorScheme === 'dark' ? 'border-theme-text-on-dark/20' : 'border-theme-text-on-light/20'
  ...
  // Link-urile folosesc culoarea accent, hover foloseste culorile de contrast din tema
  const linkClass = colorScheme === 'dark' ? 'text-theme-accent hover:text-theme-text-on-dark' : 'text-theme-primary hover:text-theme-text-on-light'
  ...
  return (
    <footer className={`${bgClass} ${textClass} relative overflow-hidden`}>
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 relative z-10">
        ...
        {/* Payment Methods - above bottom bar */}
