...
const THEME_VARIANTS = {
  ...
  'gold-navy-healing': {
    ...
    description: 'Calm, premium, spiritual. Perfect pentru terapii energetice, wellness, spa holistic.',
    colors: {
      primary: '#F5C518',
      secondary: '#1a1a2e',
      accent: '#FFD700',
  ...
  'revital-harmony': {
    ...
    description: 'Gold/Navy exact de pe terapiienergetice.ro. Elegant, calm, spiritual.',
    colors: {
      primary: '#FFE468',
      secondary: '#272630',
      accent: '#FFE468',
  ...
  'purple-wellness': {
    ...
    description: 'Mov/Cyan de pe plasturi (flat design). Modern, fresh, wellness.',
    colors: {
      primary: '#7B68EE',
      secondary: '#00CED1',
      accent: '#9370DB',
    ...
    fonts: { heading: 'Prompt', body: 'Open Sans' },
    borderRadius: 'medium',
    shadows: 'none',
  },
}
